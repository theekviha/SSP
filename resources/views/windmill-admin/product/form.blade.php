...
<div class="font-sans text-gray-900 antialiased" style="margin: 0px 200px 0px 200px">
                    ...
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            @if (strpos(url()->current(), 'edit'))
                                <div class="col-span-full">
                                    <label for="image" class="block text-sm font-medium leading-6 text-gray-900">Image Preview</label>
